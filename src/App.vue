...
<template>
  <AConfigProvider :locale="antDesignVueLocaleZhCN"
                   :theme="settingsStore.settings.app.colorScheme === 'dark' ? { algorithm: [theme.darkAlgorithm] } : {
                     token:{
                       colorPrimary: settingsStore.settings.app.colorPrimary
                     }
                   }">
    <TokenProvider>
      <RouterView
